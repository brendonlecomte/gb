...
void BIT_0_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(0, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_0_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(0, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_0_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(0, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_0_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(0, gb_cpu->E);gb_cpu->cycles += 4;
}
void BIT_0_H(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(0, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_0_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(0, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_0_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_0_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(0, gb_cpu->A);gb_cpu->cycles += 4;
}
void BIT_1_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(1, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_1_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(1, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_1_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(1, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_1_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(1, gb_cpu->E);gb_cpu->cycles += 4;
}
void BIT_1_H(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(1, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_1_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(1, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_1_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_1_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(1, gb_cpu->A);gb_cpu->cycles += 4;
}
void BIT_2_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(2, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_2_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(2, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_2_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(2, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_2_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(2, gb_cpu->E);gb_cpu->cycles += 4;
}
void BIT_2_H(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(2, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_2_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(2, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_2_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_2_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(2, gb_cpu->A);gb_cpu->cycles += 4;
}
void BIT_3_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(3, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_3_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(3, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_3_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(3, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_3_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(3, gb_cpu->E);gb_cpu->cycles += 4;
}
void BIT_3_H(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(3, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_3_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(3, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_3_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_3_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(3, gb_cpu->A);gb_cpu->cycles += 4;
}
void BIT_4_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(4, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_4_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(4, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_4_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(4, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_4_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(4, gb_cpu->E);gb_cpu->cycles += 4;
}
void BIT_4_H(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(4, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_4_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(4, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_4_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_4_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(4, gb_cpu->A);gb_cpu->cycles += 4;
}
void BIT_5_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(5, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_5_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(5, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_5_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(5, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_5_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(5, gb_cpu->E);gb_cpu->cycles += 4;
}
void BIT_5_H(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(5, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_5_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(5, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_5_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_5_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(5, gb_cpu->A);gb_cpu->cycles += 4;
}
void BIT_6_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(6, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_6_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(6, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_6_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(6, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_6_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(6, gb_cpu->E);gb_cpu->cycles += 4;
}
void BIT_6_H(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(6, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_6_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(6, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_6_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_6_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(6, gb_cpu->A);gb_cpu->cycles += 4;
}
void BIT_7_B(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(7, gb_cpu->B);gb_cpu->cycles += 4;
}
void BIT_7_C(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(7, gb_cpu->C);gb_cpu->cycles += 4;
}
void BIT_7_D(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(7, gb_cpu->D);gb_cpu->cycles += 4;
}
void BIT_7_E(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(7, gb_cpu->E);gb_cpu->cycles += 4;
}

void BIT_7_H(void) {
  DEBUG_PRINTF(": %s 0x80 & 0x%02X\n", __func__, *gb_cpu->H);
  instr_bit(7, gb_cpu->H);gb_cpu->cycles += 4;
}
void BIT_7_L(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(7, gb_cpu->L);gb_cpu->cycles += 4;
}
void BIT_7_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
void BIT_7_A(void) {
  DEBUG_PRINTF(": %s\n", __func__);
  instr_bit(7, gb_cpu->A);gb_cpu->cycles += 4;
}
...
void RES_0_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void RES_1_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void RES_2_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void RES_3_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void RES_4_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void RES_5_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void RES_6_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void RES_7_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_0_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_1_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_2_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_3_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_4_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_5_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_6_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
...
void SET_7_HLm(void) { DEBUG_PRINTF(": %s\n", __func__); assert(0);}
